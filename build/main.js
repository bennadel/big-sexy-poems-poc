    ...
    */
    Validators.composeAsync = function (validators) {
        ...
        return function (control) {
            ...
            return Object(__WEBPACK_IMPORTED_MODULE_2_rxjs__["forkJoin"])(observables).pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["c" /* map */])(_mergeErrors));
        };
    };
    return Validators;
}());
...
function toObservable(r) {
    var obs = Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["ɵisPromise"])(r) ? Object(__WEBPACK_IMPORTED_MODULE_2_rxjs__["from"])(r) : r;
...
function _mergeErrors(arrayOfErrors) {
    var res = arrayOfErrors.reduce(function (res, errors) {
        return errors != null ? Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["a" /* __assign */])({}, res, errors) : res;
    }, {});
 ...
 */
function _isAndroid() {
    var userAgent = Object(__WEBPACK_IMPORTED_MODULE_4__angular_platform_browser__["ɵgetDOM"])() ? Object(__WEBPACK_IMPORTED_MODULE_4__angular_platform_browser__["ɵgetDOM"])().getUserAgent() : '';
...
var SelectControlValueAccessor = /** @class */ (function () {
    ...
    SelectControlValueAccessor.prototype._getOptionId = function (value) {
        var e_1, _a;
        try {
            for (var _b = Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["e" /* __values */])(Array.from(this._optionMap.keys())), _c = _b.next(); !_c.done; _c = _b.next()) {
                var id = _c.value;
...
function controlPath(name, parent) {
    return Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["d" /* __spread */])(parent.path, [name]);
}
...
function _ngModelWarning(name, type, instance, warningConfig) {
    if (!Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["isDevMode"])() || warningConfig === 'never')
        return;
...
var FormGroup = /** @class */ (function (_super) {
    ...
    */
    ...
    FormGroup.prototype._allControlsDisabled = function () {
        var e_1, _a;
        try {
            for (var _b = Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["e" /* __values */])(Object.keys(this.controls)), _c = _b.next(); !_c.done; _c = _b.next()) {
...
var FormArray = /** @class */ (function (_super) {
    ...
    */
    ...
    FormArray.prototype._allControlsDisabled = function () {
        var e_2, _a;
        try {
            for (var _b = Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["e" /* __values */])(this.controls), _c = _b.next(); !_c.done; _c = _b.next()) {
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var VERSION = new __WEBPACK_IMPORTED_MODULE_1__angular_core__["Version"]('6.1.0');
...
var HttpClient = /** @class */ (function () {
    ...
    HttpClient.prototype.request = function (first, url, options) {
        ...
        var events$ = Object(__WEBPACK_IMPORTED_MODULE_2_rxjs__["of"])(req).pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["a" /* concatMap */])(function (req) { return _this.handler.handle(req); }));
        ...
        // responses(s).
        var res$ = events$.pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["b" /* filter */])(function (event) { return event instanceof HttpResponse; }));
        ...
        switch (options.observe || 'body') {
            case 'body':
                ...
                switch (req.responseType) {
                    case 'arraybuffer':
                        return res$.pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["c" /* map */])(function (res) {
                    ...
                    default:
                        ...
                        return res$.pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["c" /* map */])(function (res) { return res.body; }));
                }
            case 'response':
